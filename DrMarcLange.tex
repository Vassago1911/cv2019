...
%	 ABOUT ME
%----------------------------------------------------------------------------------------
\aboutme{ problem solver  \newline {\it analytical, creative, abstract} \newline
          { \texttt{ Automation, Prediction, Analysis.. no kind of data I can't simulate
          or model into a {\bf Aha!} Regression, that will work for years even without me :) }}
          \newline \newline  

          fluent in \newline {\it python, sql, latex, zsh, english, german } \newline
          { \texttt{ Blender, Numpy, Pandas, \LaTeX, Scikit-Learn, (Tensorflow), BERT, Tesseract, Tableau, Matomo, Google Ads, .. }}
          \newline  

          models in \newline {\it data, geometry, dynamical systems, algebra} \newline { \texttt{Natural Language Processing, (Realtime) Audio/Video Processing, automated understanding, Chatbots, Revenue Prediction, Budget Optimisation} }          

	      experienced with \newline {\it developing people, relationships, models, processes }
          \newline { \texttt{ team lead experience, consultant experience, lots of experience in educating people, sometimes
          in things I've just researched a week ago myself :) }}
} 
...
\skills{{git/3},{Linux terminal, ssh, bash, zsh/5},
		{Mobile Marketing/4},
		{SQL, Elastic, Python/5},{Teamplayer/5},
		{Data Science/6},{Abstract Mathematics/6}}
